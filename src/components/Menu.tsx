  ...
  return (
    <>
      ...
      <button 
        ...
        className="md:hidden bg-orange-500 hover:bg-orange-600 text-white rounded-full p-3 transition-all z-[60] relative"
      >
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-[70] md:hidden">
      ...
      <nav className="hidden md:block fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[60]">
      ...
      <nav className="md:hidden fixed bottom-4 left-4 right-4 z-[60]">
