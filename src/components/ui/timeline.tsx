...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl ml-28 mt-20 px-4 md:px-8 lg:px-10">
        ...
        <div className="pl-10 md:pl-[4rem] lg:pl-[4rem]">
      ...
      <div ref={ref} className="relative ml-20 max-w-7xl pl-20 pb-20">
        {data.map((item, index) => (
          <div
            key={index}
